...
class Command(BaseCommand):
    ...
    def create_site_settings(self):
        ...
        settings.theme_primary = '#EF233C'
        settings.theme_primary_hover = '#D80032'
        settings.theme_dark = '#2B2D42'
        settings.theme_accent = '#F45467'
        settings.theme_bg_light = '#EDF2F4'
        settings.theme_bg_accent = '#E3E7ED'
        settings.theme_text = '#2B2D42'
        settings.theme_text_light = '#8D99AE'
        settings.theme_success = '#2E7D32'
        settings.theme_danger = '#D80032'
        settings.theme_warning = '#F9A825'
        settings.theme_font = 'Noto Sans'
        settings.save()
